...
const Carousel = () => {
    ...
    return (
        ...
        <ul className="nav-icons">
            ...
            <button className="btn-prev-slide" onClick={prevSlide} aria-label="Previous Slide"><FontAwesomeIcon className="prev-icon" icon={faChevronRight} /></button>
            <button className="btn-next-slide" onClick={nextSlide} aria-label="Next Slide"><FontAwesomeIcon className="next-icon" icon={faChevronLeft} /></button>
